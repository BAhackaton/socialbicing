...
public class CancelBikeReservationResult extends MKResult 
{
	public String reserveCode;
	public UserStatus userStatus;

	public void parseHeader(Document doc) throws ParseHeaderException {
		this.header = new MKResultHeader("CancelBikeReservationResult");
	...
	protected void parseBody(Document doc) throws ParseBodyException
	{
		...
		{
			throw new ParseBodyException("CancelBikeReservationResult - ParseBodyException: "+e);
		}
	}
}