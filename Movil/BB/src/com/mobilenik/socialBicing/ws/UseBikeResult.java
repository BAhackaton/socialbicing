...
public class UseBikeResult extends MKResult 
{
	public Bici bike;
	public UserStatus userStatus;

	public void parseHeader(Document doc) throws ParseHeaderException {
		this.header = new MKResultHeader("UseBikeResult");
	...
	protected void parseBody(Document doc) throws ParseBodyException
	{
		...
		{
			throw new ParseBodyException("UseBikeResult - ParseBodyException: "+e);
		}
	}
}